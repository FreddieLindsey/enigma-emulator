...
basic_test_data = [
    ...
    ("No Such Plugboard Config File Test", "", ["plugboards/nulll.pb"], "",
     "FAIL"),
    ...
    # basic IO checking
    ("Basic Rotor I/O Test", "A", ["rotors/I.rot",
                                   "plugboards/I.pb"], "N", "PASS"),
    ("Invalid Input Test", "a", ["rotors/I.rot",
                                 "plugboards/I.pb"], "N", "FAIL"),

    # first char map checking
    ("First Char Mapping Test 1", "A", ["rotors/I.rot",
                                        "plugboards/null.pb"], "N", "PASS"),
    ("First Char Mapping Test 2", "B", ["rotors/II.rot",
                                        "plugboards/I.pb"], "M", "PASS"),
    ("First Char Mapping Test 3", "C", ["rotors/VII.rot",
                                        "plugboards/I.pb"], "D", "PASS"),
    ("First Char Mapping Test 4", "D",
     ["rotors/III.rot", "rotors/VII.rot", "plugboards/II.pb"], "X", "PASS"),
]

advanced_test_data = [
    # full reflector functionality checking
    ("Full Reflector Test", "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
     ["plugboards/null.pb"], "NOPQRSTUVWXYZABCDEFGHIJKLM", "PASS"),

    # full plugboard functionality checking
    ("Full Plugbaord Test 1", "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
     ["plugboards/I.pb"], "NOPQRSTUMWXYIABCDEFGHZJKLV", "PASS"),
    ("Full Plugbaord Test 2", "ABCDEFGHIJKLMNOPQRSTUVWXYZ",
     ["plugboards/II.pb"], "NOPQISTUEWMYKABCDVFGHRJZLX", "PASS"),

    # full basic rotor functionality checking
    ("Full Basic Rotor Test 1", "AAAAAAAAAAAAAAAAAAAAAAAAAA",
     ["rotors/I.rot",
      "plugboards/null.pb"], "NNNNNNNNNNNNNNNNNNNNNNNNNN", "PASS"),
    ("Full Basic Rotor Test 2", "AAAAAAAAAAAAAAAAAAAAAAAAAA",
     ["rotors/II.rot",
      "plugboards/null.pb"], "PLPLPLPLPLPLPLPLPLPLPLPLPL", "PASS"),

    # full complex rotor functionality checking
    ("Full Rotor Test 1", "AAAAAAAAAAAAAAAAAAAAAAAAAA",
     ["rotors/III.rot",
      "plugboards/null.pb"], "LLFORJEVOKWPPKRFJMGQVJMQUR", "PASS"),
    ("Full Rotor Test 2", "DDDDDDDDDDDDDDDDDDDDDDDDDD",
     ["rotors/IV.rot",
      "plugboards/null.pb"], "KYRVLIQWULYGVOAGPVAQGLIASM", "PASS"),
    ("Full Rotor Test 3", "KLKLKLKLKLKLKLKLKLKLKLKLKL",
     ["rotors/V.rot",
      "plugboards/null.pb"], "PKJSRUTBANMJIWVSRNMJISRVUQ", "PASS"),

    # full rotor cascade checking
    ("Rotor Cascade Test 1",
     "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
     ["rotors/I.rot", "rotors/II.rot", "plugboards/null.pb"
      ], "LLLLLLLLLLLLLLLLLLLLLLLLLLPPPPPPPPPPPPPPPPPPPPPPPPPP", "PASS"),
    ("Rotor Cascade Test 2",
     "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA",
     ["rotors/I.rot", "rotors/II.rot", "plugboards/IV.pb"
      ], "ZZZZZZZZZZZZZZZZZZZZZZZZZZXXXXXXXXXXXXXXXXXXXXXXXXXX", "PASS"),
    ("Rotor Cascade Test 3",
     "ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ",
     ["rotors/II.rot", "rotors/II.rot", "plugboards/null.pb"
      ], "NSPURWTYVAXCZEBGDIFKHMJOLQROTQVSXUZWBYDAFCHEJGLINKPM", "PASS"),
    ("Rotor Cascade Test 4",
     "ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ",
     ["rotors/II.rot", "rotors/II.rot", "plugboards/III.pb"
      ], "NQLWRUTCKVIYUEBGFXDKMJHRPSROPSVQIWGZBCQAFYMEHGNXLVTJ", "PASS"),
    ("Rotor Cascade Test 5",
     "ABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQRSTUVWXYZ",
...
robust_test_data = [
    ...
    ("Robustness Test 1", moby,
     ["rotors/III.rot", "rotors/VII.rot", "plugboards/II.pb"
      ], "0315f65c4d79ad398a2c59ab638b81ba8fe34480bb8cce49cbe3908065c12527  -",
     "PASS")
]
...
def run_tests(test_data, check_sha):
    ...
    for test_case in test_data:
        ...
        enigma_call = Popen(["./enigma"] + settings,
                            stdin=PIPE,
                            stdout=PIPE,
                            stderr=STDOUT)
        ...
        inverse_call = Popen(["./enigma"] + settings,
                             stdin=PIPE,
                             stdout=PIPE,
                             stderr=STDOUT)
        ...
        if test_type == "PASS" and (actual != expected or status != 0 or
                                    (inverse_error and not check_sha)):
            exit_code = 1
            print "\nFAILED: ", test_name
...
pass_tests = sum([x[0] for x in [basic_results, adv_results, robust_results]])
num_tests = sum([x[1] for x in [basic_results, adv_results, robust_results]])

sys.exit(num_tests - pass_tests)
